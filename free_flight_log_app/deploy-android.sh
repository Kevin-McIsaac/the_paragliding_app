#!/bin/bash
# Deploy Free Flight Log to Pixel 9 wirelessly
# Complete Android SDK configuration script

set -e  # Exit on any error

echo "🚀 Deploying Free Flight Log to Pixel 9 wirelessly..."
...
if [ $? -eq 0 ]; then
    ...
    if [ $? -eq 0 ]; then
        ...
        ~/platform-tools-new/platform-tools/adb -s 192.168.86.250:34695 shell am start -n com.freeflightlog.free_flight_log_app/com.freeflightlog.free_flight_log_app.MainActivity
        echo "✅ Free Flight Log is now running on your Pixel 9!"
    else
