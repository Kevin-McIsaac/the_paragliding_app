...
class AirspaceDiskCache {
  ...
  Database? _database;
  Future<Database>? _initializationInProgress;
  ...
  Future<Database> get database async {
    ...
    // Start initialization and track the Future
    _initializationInProgress = _initDatabase();
    try {
      _database = await _initializationInProgress!;
      return _database!;
    } finally {
